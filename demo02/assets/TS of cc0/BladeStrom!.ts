...
export class BladeStrom extends Component {
    ...
    ring(){
        ...
        const point4 = instantiate(this.effect[6]) as Node;
        point4.setParent(this.node.parent);
        point4.setWorldPosition(1,2,4.5);
        const point5 = instantiate(this.effect[7]) as Node;
